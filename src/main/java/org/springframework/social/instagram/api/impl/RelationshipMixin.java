...
public class RelationshipMixin {
	@JsonCreator
	RelationshipMixin(@JsonProperty("outgoing_status") @JsonDeserialize(using = OutgoingDeserializer.class) OutgoingStatus outgoingStatus,
	...
	private static class OutgoingDeserializer extends JsonDeserializer<OutgoingStatus> {
		@Override
		public OutgoingStatus deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
	...
	private static class IncomingDeserializer extends JsonDeserializer<IncomingStatus> {
		@Override
		public IncomingStatus deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
